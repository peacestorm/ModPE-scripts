...
function showHacksList(){
    ...
    //--------Add Buttons-------//
					...
					var StatesText = minecraftText(StateText + State1Text + State2Text + State3Text + State4Text + State5Text + State6Text + State7Text + State8Text + State9Text + State10Text + State11Text + State12Text + State13Text + State14Text + State15Text + State16Text + State17Text + State18Text + State19Text + State20Text + State21Text + State22Text + State23Text + StateTwerkText + StateDerpText);
					StatesText.setTextSize(10);
					//StatesText.setText(StateText + State1Text); //Title
...
function morphScreen(){
    ...
    ctx.runOnUiThread(new java.lang.Runnable({ run: function(){
    try{
    var morphMenuLayout = new android.widget.LinearLayout(ctx);
    var morphMenuScroll = new android.widget.ScrollView(ctx);
    var morphMenuLayout1 = new android.widget.LinearLayout(ctx);
    morphMenuLayout.setOrientation(1);
    morphMenuLayout1.setOrientation(1);
    morphMenuScroll.addView(morphMenuLayout);
    morphMenuLayout1.addView(morphMenuScroll);
    //--------Add Buttons-------//
					/*var newLineText = new android.widget.TextView(ctx);
					var authorText = new android.widget.TextView(ctx);
					var currentModVersionText = new android.widget.TextView(ctx);
					...
					var morphOkBtn = minecraftButton("Ok");
					var spritesheet = android.graphics.Bitmap.createScaledBitmap(trimImage(GetSpritesheet(), 0, 0, 16, 16), 16*GuiSize, 16*GuiSize, false);
					...
					var newLineTextMorph = minecraftText("\n");
                    ...
                    morphMenuLayout.addView(btn);
                    morphMenuLayout.addView(btn1);
                    morphMenuLayout.addView(btn2);
                    morphMenuLayout.addView(btn3);
					morphMenuLayout.addView(btn4);
					morphMenuLayout.addView(btn5);
					morphMenuLayout.addView(btn6);
					morphMenuLayout.addView(btn7);
					//morphMenuLayout.addView(btn8);
					morphMenuLayout.addView(btn9);
					morphMenuLayout.addView(btn10);
                    morphMenuLayout.addView(btn11);
					morphMenuLayout.addView(btn12);
					morphMenuLayout.addView(btn13);
					morphMenuLayout.addView(btn14);
					morphMenuLayout.addView(btn15);
					morphMenuLayout.addView(btn16);
					//morphMenuLayout.addView(btn17);
					morphMenuLayout.addView(btn18);
					morphMenuLayout.addView(btn19);
					morphMenuLayout.addView(newLineTextMorph);
					morphMenuLayout.addView(morphOkBtn);
					//morphMenuLayout.addView(btnCircular);
					/*newLineText.setText("\n");
					authorText.setText("Author : " + MOD_AUTHOR);
					currentModVersionText.setText("Current mod version : v" + CURRENT_VERSION);
					targetMCPEVersionText.setText("Target MCPE version : v" + targetMCPEVersion);
                    ...
                    morphOkBtn.setOnClickListener(new android.view.View.OnClickListener() {
                        onClick: function(view) {
							Level.playSound(Player.getX(), Player.getY(), Player.getZ(), "random.click", 100, 100);
                            morphMenu.dismiss();
                        }
    ...
    //More buttons...
    morphMenu = new android.widget.PopupWindow(morphMenuLayout1, ctx.getWindowManager().getDefaultDisplay().getWidth(), ctx.getWindowManager().getDefaultDisplay().getHeight());
    morphMenu.setBackgroundDrawable(getStretchedImage(spritesheet, 4*GuiSize, 4*GuiSize, 8*GuiSize, 8*GuiSize,getContext().getScreenWidth()/2, getContext().getScreenHeight()));
    morphMenu.showAtLocation(ctx.getWindow().getDecorView(), android.view.Gravity.CENTER | android.view.Gravity.TOP, 0, 0);
    }catch(error){
    print('An error occured: ' + error);
    }
    }}));
