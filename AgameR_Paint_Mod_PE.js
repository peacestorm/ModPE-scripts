...
function attackHook(attacker, victim) {
    ...
    if (attacker == Player.getEntity()) {
        if (selecteditem == 394) {
			...
			}}else if (Entity.getEntityTypeId(victim)==1||Entity.getEntityTypeId(victim)==2||Entity.getEntityTypeId(victim)==3||Entity.getEntityTypeId(victim)==4||Entity.getEntityTypeId(victim)==5||Entity.getEntityTypeId(victim)==6||Entity.getEntityTypeId(victim)==7||Entity.getEntityTypeId(victim)==8||Entity.getEntityTypeId(victim)==9||Entity.getEntityTypeId(victim)==10||Entity.getEntityTypeId(victim)==11||Entity.getEntityTypeId(victim)==12||Entity.getEntityTypeId(victim)==13||Entity.getEntityTypeId(victim)==14||Entity.getEntityTypeId(victim)==15||Entity.getEntityTypeId(victim)==16||Entity.getEntityTypeId(victim)==17||Entity.getEntityTypeId(victim)==18||Entity.getEntityTypeId(victim)==19||Entity.getEntityTypeId(victim)==20||Entity.getEntityTypeId(victim)==21||Entity.getEntityTypeId(victim)==22||Entity.getEntityTypeId(victim)==23||Entity.getEntityTypeId(victim)==24||Entity.getEntityTypeId(victim)==25||Entity.getEntityTypeId(victim)==26||Entity.getEntityTypeId(victim)==27||Entity.getEntityTypeId(victim)==28||Entity.getEntityTypeId(victim)==29||Entity.getEntityTypeId(victim)==30||Entity.getEntityTypeId(victim)==31||Entity.getEntityTypeId(victim)==32||Entity.getEntityTypeId(victim)==33||Entity.getEntityTypeId(victim)==34||Entity.getEntityTypeId(victim)==35||Entity.getEntityTypeId(victim)==36||Entity.getEntityTypeId(victim)==37||Entity.getEntityTypeId(victim)==38||Entity.getEntityTypeId(victim)==39||Entity.getEntityTypeId(victim)==40||Entity.getEntityTypeId(victim)==41||Entity.getEntityTypeId(victim)==42){
			preventDefault();
